...
@Component({
  imports: [HeaderbodComponent, ReactiveFormsModule,CommonModule,NgIf,NgClass],
  selector: 'app-usuariobod',
  standalone:true,
  templateUrl: './usuariobod.component.html',
  styleUrls: ['./usuariobod.component.css']
})
export class UsuariobodComponent implements OnInit {
